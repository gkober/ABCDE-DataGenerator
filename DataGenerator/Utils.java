...
public class Utils {
		...
		public static Map<String,String> queryBioPortalOntologies(String loincCode) {
			...
			String API_KEY = "bc6b5d4b-7fb2-40a8-a518-fca09eff99d6";
			URL url;
		...
		private void fillMap_nameToCode() {
			...
			this.mappingNameToCode.put("chestExpansionSymmetric", "248562002"); //http://purl.bioontology.org/ontology/SNOMEDCT/248562002 -- Paradoxical chest movement
