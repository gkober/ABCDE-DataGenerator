...
public class generateObservationSamples {
	...
	public static void main(String[] args) throws IOException, NoSuchMethodException, SecurityException {
		...
		String submitFhirResourcesToFhirStore = "bla";
		String storeRDFRepresentation = "blub";
		...
		for(int i = 0;i <numberOfLinesToGenerate; i++) {
				...
				utils.dataLine.add(new String[] {
						...
						observation.getChestExpansionSymmetric(),
		...
		if(createFhirResources_boolean==true) {
			readCSVandTriggerFHIRGeneration();
		}else {
			System.out.println("Exiting - CSV-generation done");
		}
	}
	
	public static void readCSVandTriggerFHIRGeneration() throws IOException, NoSuchMethodException, SecurityException {
		...
		while ((row = csvReader.readLine()) != null) {
		    ...
		    for(int i=0; i<data.length;i++) {
				...
				observation.setChestExpansionSymmetric(data[15]);
