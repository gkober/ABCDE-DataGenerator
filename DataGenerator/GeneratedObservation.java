...
public class GeneratedObservation {
	...
	String chestExpansionSymmetric = null;
	...
	public void printResults() {
		...
		System.out.println("chestExpansionSymmetric: " + chestExpansionSymmetric);
	...
	public void generatePotentialCriticalIllPatientData() {
		...
		if (breathes == "NO") {
			...
			chestExpansionSymmetric = this.utils.getRandomTrueFalse();
	...
	public void generateHealthyPatientData() {
		...
		breathes = "YES";
		cyanosis = "NO";
		respiratoryRate = this.utils.getRandomNumber(12, 20);
		chestExpansion = "NORMAL";
		respiratoryRhythm = "NORMAL";
		chestExpansionSymmetric = "YES";
		...
		gcsnumber = this.utils.getRandomNumber(6, 7);					
	...
	public String getChestExpansionSymmetric() {
		return chestExpansionSymmetric;
	}
	...
	public void setChestExpansionSymmetric(String chestExpansionSymmetric) {
		this.chestExpansionSymmetric = chestExpansionSymmetric;
	}
